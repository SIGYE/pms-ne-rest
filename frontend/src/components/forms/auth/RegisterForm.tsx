    ...
    >
      ...
      <div>
        ...
        <Input
          ...
          type="email"
          {...register("email")}
          className="border-black focus:ring-blue-500  py-6"
        />
        {errors.email && (
          <p className="text-blue-600 text-sm mt-1">{errors.email.message}</p>
        )}
      </div>
      ...
      <div>
        ...
        />
        {errors.names && (
          <p className="text-blue-600 text-sm mt-1">{errors.names.message}</p>
        )}
      </div>
      ...
      <Button
        ...
        className="w-full bg-blue-700 hover:bg-gray-800 py-6 focus:ring-blue-500"
      >
